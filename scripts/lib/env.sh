...
viva_export_compatibility_env() {
  ...
  viva_map_env VIVA_CURSOR_VOICED_GATE AIM_CURSOR_VOICED_GATE
  viva_map_env VIVA_BARGE_OPEN_COOLDOWN_MS AIM_BARGE_OPEN_COOLDOWN_MS
  viva_map_env VIVA_BARGE_OPEN_COOLDOWN_MULT AIM_BARGE_OPEN_COOLDOWN_MULT
